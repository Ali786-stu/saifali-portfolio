  ...
  const projects = [
    {
      ...
      fullDescription: "A comprehensive e-commerce solution built with React and Node.js...",
      image: img1,
    ...
    },
    {
      id: 2,
      title: "Work Whiz",
      description: "WorkWhiz is a platform that instantly connects people with skilled local workers.",
      fullDescription: "WorkWhiz (accessible at workwhizapp.in) is a digital platform...",
      image: workWhiz,
      ...
      duration: "5 months",
      status: false,
      features: ["Instant Worker Matching", "Wide Range of Services", "Verified Profiles"],
    },
    {
      id: 3,
      title: "Alig Foundation",
      description: "Coaching platform guiding students with quality education & mentorship.",
      fullDescription: "Alig Foundation (accessible at aligfoundation.com) is an educational platform...",
    ...
    },
    {
      ...
      fullDescription: "Zaphira Organic offers premium Ayurvedic skincare and haircare products...",
      image: zaphira,
    ...
    },
    {
      ...
      fullDescription: "The Expense Tracker App is designed to help individuals manage finances...",
    ...
    },
    {
      ...
      fullDescription: "Fit Plus is a modern exercise app built with React & Tailwind...",
      image: fitPlus,
